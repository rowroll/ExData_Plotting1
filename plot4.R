...
# Plot 1,1
with(data, plot(dateCol, Global_active_power, type="l",col="black", xlab="", ylab="Global Active Power"))

# Plot 1,2
with(data, plot(dateCol, Voltage, type="l",col="black", xlab="datetime", ylab="Voltage"))
...
# Plot 2,2
with(data, plot(dateCol, Global_reactive_power, type="l", col="black", xlab="datetime", ylab="Global_reactive_power"))
